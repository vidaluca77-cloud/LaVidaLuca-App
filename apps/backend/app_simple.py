...
ACTIVITIES_DATA = [
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Alimentation, eau, observation et bien-être du troupeau.",
    },
    {
        ...
        "duration": 90,
        "safety": 2,
        "desc": "Hygiène, tonte (démonstration) et soins courants.",
    },
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Poules, canards, lapins : alimentation, abris, propreté.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Semis, arrosage, paillage, suivi des jeunes plants.",
    },
    {
        ...
        "duration": 120,
        "safety": 1,
        "desc": "Plan de culture, entretien, récolte respectueuse.",
    },
    {
        ...
        "duration": 120,
        "safety": 2,
        "desc": "Identifier, réparer et sécuriser parcs et abris.",
    },
    {
        ...
        "duration": 90,
        "safety": 2,
        "desc": "Du lait au caillé : hygiène, moulage, affinage (découverte).",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Préparation, stérilisation, mise en pot, étiquetage.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Lavage, cardage et petite création textile.",
    },
    {
        ...
        "duration": 90,
        "safety": 2,
        "desc": "Du verger à la bouteille : tri, pressage, filtration.",
    },
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Cueillette, séchage doux et conditionnement.",
    },
    {
        ...
        "duration": 120,
        "safety": 2,
        "desc": "Pétrissage, façonnage, cuisson : respect des temps.",
    },
    {
        ...
        "duration": 120,
        "safety": 2,
        "desc": "Petites structures bois : plan, coupe, assemblage.",
    },
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Affûtage, graissage, vérifications simples.",
    },
    {
        ...
        "duration": 120,
        "safety": 2,
        "desc": "Mesure, coupe, ponçage, finitions.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Préparer, protéger, peindre proprement.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Désherbage doux, paillage, plantations.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Concevoir et poser une signalétique claire.",
    },
    {
        ...
        "duration": 90,
        "safety": 2,
        "desc": "Nettoyage doux, observation des berges.",
    },
    {
        ...
        "duration": 120,
        "safety": 1,
        "desc": "Choix d'essences, tuteurage, paillage, suivi.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Associations, paillis, rotation des cultures.",
    },
    {
        "title": "Compostage",
        "category": "nature",
        "duration": 60,
        "safety": 1,
        "desc": "Tri, compost et valorisation des déchets verts.",
    },
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Discrétion, repérage, traces/indices.",
    },
    {
        ...
        "duration": 120,
        "safety": 1,
        "desc": "Concevoir, fabriquer, installer des abris.",
    },
    {
        ...
        "duration": 180,
        "safety": 1,
        "desc": "Préparer, accueillir, guider un public.",
    },
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Présenter la ferme et répondre simplement.",
    },
    {
        ...
        "duration": 90,
        "safety": 2,
        "desc": "Jeux, découvertes nature, mini-gestes encadrés.",
    },
    {
        ...
        "duration": 90,
        "safety": 1,
        "desc": "Préparer un repas simple et bon.",
    },
    {
        ...
        "duration": 60,
        "safety": 1,
        "desc": "Organisation, service, convivialité, propreté.",
    },
    {
        ...
        "duration": 180,
        "safety": 1,
        "desc": "Stand, présentation, caisse symbolique (simulation).",
    },
]
    ...
    try:
        ...
        if search:
            ...
            activities = [
                ...
                or search_lower in a["desc"].lower()
            ]
        ...
        raise HTTPException(
            status_code=500, detail="Erreur lors de la récupération des activités"
        )
