...
def filter_transaction_data(event: Dict[str, Any], hint: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    """
...
def set_request_context(request_id: str, method: str, path: str, user_agent: Optional[str] = None):
    """
...
def capture_exception_with_context(exception: Exception, context: Optional[Dict] = None, tags: Optional[Dict] = None):
    """
...
def capture_message_with_context(message: str, level: str = "info", context: Optional[Dict] = None, tags: Optional[Dict] = None):
    """
