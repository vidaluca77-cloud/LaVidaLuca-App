...
```
        ...
        servers=[
            {"url": "https://api.lavidaluca.fr", "description": "Production"},
            {"url": "https://staging-api.lavidaluca.fr", "description": "Staging"},
    ...
    openapi_schema["components"]["schemas"].update(
        {
            ...
            "ApiResponse": {
                ...
                "properties": {
                    ...
                    "data": {"description": "Données de la réponse"},
                ...
                "properties": {
                    ...
                    "error": {
                        ...
                        "properties": {
                            ...
                            "details": {"description": "Détails de l'erreur"},
                        },
