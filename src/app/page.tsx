      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Réseau national de fermes pédagogiques dédiées à la formation des
            jeunes et au développement d'une agriculture vivante et
            respectueuse.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-8">
            ...
            <p className="text-gray-600">
              Partenariats avec les Maisons Familiales Rurales pour offrir aux
              élèves une formation pratique et humaine dans un cadre
              authentique.
            </p>
          </div>
          ...
          <div className="text-center p-8">
            ...
            <p className="text-gray-600">
              Développement de pratiques agricoles durables respectueuses de
          ...
          <div className="text-center p-8">
            ...
            <p className="text-gray-600">
              Accompagnement personnalisé de chaque jeune vers l'autonomie et
  ...
  const categoryOptions = [
    {
      id: 'agri',
      name: 'Agriculture',
      desc: 'Élevage, cultures, soins aux animaux',
    },
    {
      id: 'transfo',
      name: 'Transformation',
      desc: 'Fromage, conserves, pain...',
    },
    {
      id: 'artisanat',
      name: 'Artisanat',
      desc: 'Menuiserie, construction, réparation',
    },
    {
      id: 'nature',
      name: 'Environnement',
      desc: 'Plantation, compostage, écologie',
    },
    {
      id: 'social',
      name: 'Animation',
      desc: 'Accueil, visites, ateliers enfants',
    },
  ];
    ...
    return (
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Sélectionnez vos compétences actuelles ou celles que vous aimeriez
            développer
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="mb-6">
            <div className="flex items-center space-x-4 text-sm text-gray-600 mb-4">
              ...
              <div
                className={`px-2 py-1 rounded-full text-xs font-medium ${getSafetyColor(selectedActivity.safety_level)}`}
              >
          ...
          <div className="flex justify-between mt-8">
            ...
            <button
              onClick={() => {
                alert(
                  'Inscription enregistrée ! Un encadrant vous contactera bientôt.'
                );
                setShowGuide(false);
              }}
              className="bg-green-500 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-600 transition-colors"
        ...
        {suggestions.map((suggestion, index) => (
          ...
          >
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600 mb-4">
              ...
              <div
                className={`px-2 py-1 rounded-full text-xs font-medium ${getSafetyColor(suggestion.activity.safety_level)}`}
              >
...
const App = () => {
  const [currentPage, setCurrentPage] = useState<
    'home' | 'onboarding' | 'suggestions' | 'catalog'
  >('home');
